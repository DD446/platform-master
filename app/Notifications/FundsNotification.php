...
class FundsNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ...
                ->line(trans_choice('bills.notification_funds_message', $notifiable->activity_characteristic, ['description' => $notifiable->activity_description, 'amount' => $notifiable->amount, 'currency' => $notifiable->currency, 'funds' => $notifiable->user->funds]) )
