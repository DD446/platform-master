...
return [
     ...
     */
    'title' => 'podcaster API documentation',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Through the podcaster API you can access your media files, podcast feeds, episodes and statistics.',

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => 'https://www.podcaster.de',
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by visiting <a href="https://www.podcaster.de/apps" target="_blank">your personal key management site</a>. There you can create either a personal code (use as <em>Bearer</em> code which you can (also) use for the live examples on this page) or an OAuth client id. Please do not try to build your own (hosting/podcast) service or an user frontend directly on top of our infrastructure. Always cache your requests.',
    ],
...
INTRO
     ...
     *
     */
    'logo' => '/images1/podcaster_logo_api_weiss_245x100_trans.png',
