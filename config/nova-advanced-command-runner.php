...
return [
    'commands' => [
        ...
        'Forget Cache variable' => [
            ...
            'variables' => [
                [
                    ...
                    'options' => [
                        'ADSWIZZ_PUBLISHERS' => 'ADSWIZZ PUBLISHERS',
                    ],
        ...
        'Refresh User Feeds' => [
            'run' => 'podcaster:refresh-user-feeds {userId}',
            'type' => 'info',
            'group' => 'Feeds',
            'variables' => [
                [
                    'label' =>  'userId', // This needs to match with variable defined in the command
                    'field' => 'text', // Allowed values (text,number,tel,select,date,email,password)
                    'placeholder' => 'User-ID, Username oder E-Mail'
                ]
            ]
        ],
    /**
