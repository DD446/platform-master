...
<p>
    <small class="header">Auftragsverarbeitungsvertrag podcaster.de, Version 1.4, Stand: 17.12.2021</small>
</p>
...
<table>
    ...
    <tr>
        <td>Straße Nr.:</td>
        <td>Brunnenstraße 147</td>
    </tr>
    <tr>
        <td>PLZ, Ort, Land:</td>
        <td>10115 Berlin, Deutschland</td>
    </tr>
</table>
    ...
    <li>
        ...
        <ul class="sublist">
            <li>
                ...
                <p>
                    Der Auftragnehmer darf keine weiteren Auftragsverarbeiter ohne vorherige gesonderte Genehmigung des Auftraggebers in Anspruch nehmen.
                </p>
            </li>
            <li>
