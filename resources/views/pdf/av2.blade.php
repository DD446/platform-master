...
<p>
    <small class="header">Auftragsverarbeitungsvertrag podcaster.de, Version 1.1, Stand: 1. April 2020</small>
</p>

<div style="margin: 10px 0;padding: 10px 0">
    <img src="{{ asset('images1/podcaster_logo.svg') }}" alt="Logo" style="width: 275px">
</div>
